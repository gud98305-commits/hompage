...
AI 패션 큐레이터, 성수동 테마 RPG 게임, AI 포토부스를 하나의 플랫폼에 통합한 웹 애플리케이션입니다.
...
| **Frontend** | HTML5/CSS3/Vanilla JS, Next.js 14 (포토부스), Tailwind CSS |
...
│   └── data/                 # 크롤링 결과 JSON
│
├── game/                      # RPG 게임 엔진 및 리소스
│   └── engine/seongsu_rpg_project/
│
├── miniproject_2/photobooth/  # Next.js 포토부스 앱
│   ├── app/                  # Next.js App Router
│   ├── data/                 # 스타일/포즈 프리셋 JSON
│   └── public/references/    # 갤러리 레퍼런스 이미지
│
├── assets/                    # 프론트엔드 정적 파일
│   ├── css/                  # 스타일시트
│   ├── js/                   # JavaScript 모듈
...
│
├── data/                      # 런타임 데이터
│   ├── products_raw.json    # 크롤링 원본 데이터
│   ├── products_enriched.json # AI 보강 데이터
│   └── *.db                 # SQLite 데이터베이스
│
...
| `GDRIVE_FOLDER_ID` | Google Drive 폴더 ID (크롤러) | - |
