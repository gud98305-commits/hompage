...
// ── 2. 에셋 로딩 ──
// 주인공 스프라이트시트 (4x4)
loadSprite("player_char", "/assets/rpg/player_spritesheet.png", {
  sliceX: 4,
  sliceY: 4,
  anims: {
...
// 배경
loadSprite("bg_city", "/assets/rpg/final_back.jpg")
loadSprite("graffiti_wall", "/assets/rpg/graffiti_wall.png")
loadSprite("road", "/assets/rpg/road.png")

// 건물들
loadSprite("building_dior", "/assets/rpg/building_dior.png")
loadSprite("building_onion", "/assets/rpg/building_onion.png")
loadSprite("building_tamburins", "/assets/rpg/building_tamburins.png")
loadSprite("building_musinsa", "/assets/rpg/building_musinsa.png")
loadSprite("building_blueelephant", "/assets/rpg/building_blueelephant.png")
loadSprite("building_covernat", "/assets/rpg/building_covernat.png")
loadSprite("building_pointofview", "/assets/rpg/building_pointofview.png")
loadSprite("building_nyunyu", "/assets/rpg/building_nyunyu.png")
loadSprite("building_matinkim", "/assets/rpg/building_matinkim.png")
loadSprite("building_adererror", "/assets/rpg/building_adererror.png")
loadSprite("building_popup1", "/assets/rpg/building_popup1.png")
loadSprite("building_popup2", "/assets/rpg/building_popup2.png")
loadSprite("building_photoism", "/assets/rpg/building_photoism.png")
loadSprite("building_zenmon", "/assets/rpg/building_zenmon.png")
loadSprite("building_zenmon_popup", "/assets/rpg/building_zenmon_popup.png")
loadSprite("building_random1", "/assets/rpg/building_random1.png")
loadSprite("building_random2", "/assets/rpg/building_random2.png")
loadSprite("building_random3", "/assets/rpg/building_random3.png")
loadSprite("building_random4", "/assets/rpg/building_random4.png")
loadSprite("building_random5", "/assets/rpg/building_random5.png")
loadSprite("building_random6", "/assets/rpg/building_random6.png")
loadSprite("building_random7", "/assets/rpg/building_random7.png")

// NPC (캐릭터 시트를 슬라이싱해서 첫 프레임만 사용)
loadSprite("npc_hoodie_boy", "/assets/rpg/npc_hoodie_boy.png", { sliceX: 5, sliceY: 2 })
loadSprite("npc_phone_girl", "/assets/rpg/npc_phone_girl.png", { sliceX: 4, sliceY: 2 })
loadSprite("npc_headphone_girl", "/assets/rpg/npc_headphone_girl.png", { sliceX: 3, sliceY: 2 })
loadSprite("npc_colorful_boy", "/assets/rpg/npc_colorful_boy.png", { sliceX: 2, sliceY: 1 })
loadSprite("npc_walking_boy", "/assets/rpg/npc_walking_boy.png", { sliceX: 3, sliceY: 2 })
loadSprite("npc_pink_girl", "/assets/rpg/npc_pink_girl.png", { sliceX: 3, sliceY: 1 })
loadSprite("npc_denim_boy", "/assets/rpg/npc_denim_boy.png", { sliceX: 2, sliceY: 1 })

// 포장마차
loadSprite("food_cart", "/assets/rpg/food_cart.png")
...
for (let i = 1; i <= 9; i++) {
  ITEM_DB[`covernat_${i}`] = {
    ...
    image: `/assets/rpg/covernat_${i}.jpg`,
    energy: 0
  };
}
...
scene("main", () => {
  ...
  // ── BGM 설정 ──
  const bgm = new Audio('/assets/rpg/main_bgm1.mp3')
  bgm.loop = true
  ...
  // ── NPC 대화 효과음 ──
  const sfxDialog = new Audio('/assets/rpg/npc_sound.mp3')
  ...
  const NPCS = [
    {
      ...
      spriteKey: null,
      x: 3900, npcScale: 0.1,
      portrait: "/assets/rpg/npc_phone_girl.png",
      modal: null,
      lines: [
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_headphone_girl.png",
      modal: { name: "어니언 성수", image: "/assets/rpg/building_onion.png", desc: "성수동 대표 카페. 공장을 개조한 독특한 인테리어.", link: "https://www.instagram.com/onion.seongsu" },
      lines: [
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_pink_girl.png",
      modal: { name: "디올 성수", image: "/assets/rpg/building_dior.png", desc: "디올의 성수동 플래그십 스토어. 화려한 외관이 인상적.", link: "https://www.dior.com" },
      lines: [
        "ディオール聖水へようこそ。\n디올 성수에 오신 걸 환영합니다.",
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_phone_girl.png",
      modal: { name: "탬버린즈", image: "/assets/rpg/building_tamburins.png", desc: "젠틀몬스터 그룹의 향수 브랜드. 독창적인 향수 라인업.", link: "https://www.tamburins.com" },
      lines: [
        "タンバリンズへようこそ！\n탬버린즈에 오신 걸 환영해요!",
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_hoodie_boy.png",
      modal: { name: "무신사 스탠다드 성수", image: "/assets/rpg/building_musinsa.png", desc: "무신사의 오프라인 플래그십 스토어.", link: "https://store.musinsa.com", type: "musinsa" },
      lines: [
        "ムシンサスタンダード聖水へようこそ！\n무신사 스탠다드 성수에 오신 걸 환영합니다!",
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_colorful_boy.png",
      modal: { name: "블루엘리펀트", image: "/assets/rpg/building_blueelephant.png", desc: "성수동 복합문화공간. 전시와 공연이 열리는 곳.", link: "https://www.instagram.com/blueelephant_seoul" },
      lines: [
    ...
    },
    {
      ...
      x: 300, npcScale: 0.15,
      portrait: "/assets/rpg/npc_denim_boy.png",
      modal: { name: "커버낫 성수", image: "/assets/rpg/building_covernat.png", desc: "스트릿 캐주얼 브랜드 커버낫의 성수 플래그십.", link: "https://covernat.net", type: "covernat" },
      lines: [
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_walking_boy.png",
      modal: { name: "포인트오브뷰", image: "/assets/rpg/building_pointofview.png", desc: "성수동의 독립서점. 감성적인 독립출판물이 가득.", link: "https://www.instagram.com/point.of.view.seoul" },
      lines: [
        "ポイントオブビューへようこそ。\n포인트오브뷰에 오신 걸 환영합니다.",
        "ここは聖水洞の独立書店です。\n여기는 성수동의 독립서점이에요.",
        "この本を一冊おすすめします！\n이 책 한 권 추천드릴게요!",
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_pink_girl.png",
      modal: { name: "마뗑킴", image: "/assets/rpg/building_matinkim.png", desc: "감각적인 여성 패션 브랜드 마뗑킴의 성수 매장.", link: "https://www.matinkim.com", type: "matinkim" },
      lines: [
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_colorful_boy.png",
      modal: { name: "아더에러", image: "/assets/rpg/building_adererror.png", desc: "성수동 본사를 둔 감성 스트릿 브랜드.", link: "https://adererror.com" },
      lines: [
        "アーダーエラー聖水本社前だよ。\n아더에러 성수 본사 앞이야.",
        "このレンガ建物の雰囲気、やばくない？\n이 벽돌 건물 분위기 미쳤지?",
    ...
    },
    {
      ...
      x: 900, npcScale: 0.35,
      portrait: "/assets/rpg/npc_hoodie_boy.png",
      modal: { name: "AEAE 팝업스토어", image: "/assets/rpg/building_popup1.png", desc: "지금 성수에서 가장 핫한 AEAE 팝업스토어입니다!", link: "/aeae_popup/index.html" },
      lines: [
        "ここのポップアップストア見た？！\n여기 팝업스토어 봤어?!",
    ...
    },
    {
      ...
      portrait: "/assets/rpg/npc_phone_girl.png",
      modal: { name: "포토이즘", image: "/assets/rpg/building_photoism.png", desc: "인생네컷 포토부스. 다양한 테마의 사진을 남길 수 있다.", link: "https://photoism.co.kr" },
      lines: [
        "フォトイズムへようこそ！\n포토이즘에 오신 걸 환영해요!",
        "人生4カット、一枚撮っていってください～\n인생네컷 한 장 찍어 가세요~",
        "はい、写真です！よく撮れましたよ！\n자, 여기 사진이요! 잘 나왔네요!",
